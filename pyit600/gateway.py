        ...
        if thermostats:
            ...
            for thermostat_status in status["id"]:
                ...
                thermostat = ClimateDevice(
                    ...
                    max_temp=35 if "MaxHeatSetpoint_x100" not in th else th["MaxHeatSetpoint_x100"] / 100,
                    min_temp=5 if "MinHeatSetpoint_x100" not in th else th["MinHeatSetpoint_x100"] / 100,
